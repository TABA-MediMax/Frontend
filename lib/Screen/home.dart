...
class _StartPageState extends State<StartPage> {
  ...
  pickImage(BuildContext context) async {
    final ImagePicker picker = ImagePicker();
    File pickedImage1 = (await picker.pickImage(source: ImageSource.camera)) as File;
    if (pickedImage1 != null) {
      print(pickedImage1.path);
      if (this.mounted) {
        await Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => ImagePage(localImagePath: pickedImage1.path),
          ),
        );
      }
    }
  ...
  Widget build(BuildContext context) {
            ...
            Container(
              child: Row(
                ...
                children: [
                  ...
                  OutlinedButton(
                    onPressed: () {},
                    child: Text('케토톱', style: TextStyle(fontSize: 20, color: Colors.black)),
                  ),
                  SizedBox(width: 20),
                  OutlinedButton(
                    onPressed: () {},
    ...
    icon: Icon(Icons.satellite, size: 230, color: Colors.white),
    ),
    ],
    ),
    ),
    ...
    icon: Icon(Icons.camera_alt, size: 80, color: Colors.white),
    ),
    SizedBox(width: 10),
    IconButton(
    onPressed: () {
    ...
    icon: Icon(Icons.settings, size: 80, color: Colors.white),
    ),
    SizedBox(width: 5),
